...
sed -i 's/PUBLIC_UPSTREAM="127.0.0.1:7555"/PUBLIC_UPSTREAM="127.0.0.1:7666"/' "${T}/etc/router-ip-push-hardening/config.env"
...
sed -i 's/PUBLIC_UPSTREAM="127.0.0.1:7666"/PUBLIC_UPSTREAM="127.0.0.1:7777"/' "${T}/etc/router-ip-push-hardening/config.env"
