...
cat >>"${LOG}" <<'LOG2'
2026-08-17T14:00:02+00:00 src=192.0.2.25 route=xray_1 sni=private-a.example.net upstream=127.0.0.1:8443 status=200 session=20.000
